...
async function loadGame(): Promise<void> {
  ...
  document.querySelector<HTMLDivElement>('#app')!.innerHTML = `
    <div class="stage-viewport"><main class="game-stage"><div class="game-presentation"><div class="cabinet-art" aria-hidden="true"></div><div class="game-ui">
      ...
      <section class="hud-zone"><div class="hud-item"><span>BALANCE</span><strong data-balance>$100.00</strong></div><div class="hud-item"><span>BET</span><strong>$1.00</strong></div><div class="hud-item"><span>WIN</span><strong data-win>$0.00</strong></div></section>

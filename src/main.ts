...
async function loadGame(): Promise<void> {
  ...
  document.querySelector<HTMLDivElement>('#app')!.innerHTML = `
    <div class="stage-viewport"><main class="game-stage"><div class="cabinet-motion"><div class="cabinet-composition"><div class="game-presentation"><div class="cabinet-art" aria-hidden="true"></div><div class="game-ui">
      ...
      <section class="jackpot-zone"><div class="jackpot-card jackpot-card--grand"><span class="jackpot-label">GRAND</span><strong data-jackpot-grand>${money(jackpots.grandValue)}</strong></div><div class="jackpot-card jackpot-card--mini"><span class="jackpot-label">MINI</span><strong>${money(20)}</strong></div><div class="jackpot-card jackpot-card--major"><span class="jackpot-label">MAJOR</span><strong data-jackpot-major>${money(jackpots.majorValue)}</strong></div><div class="jackpot-card jackpot-card--minor"><span class="jackpot-label">MINOR</span><strong>${money(50)}</strong></div></section>
  ...
  await createPixiGame({ host: document.querySelector<HTMLDivElement>('.pixi-layer')!, presentation: document.querySelector<HTMLElement>('.game-presentation')!, jackpots, majorElement: document.querySelector<HTMLElement>('[data-jackpot-major]')!, grandElement: document.querySelector<HTMLElement>('[data-jackpot-grand]')!, messageElement: document.querySelector<HTMLElement>('[data-message]')!, winElement: document.querySelector<HTMLElement>('[data-win]')!, balanceElement: document.querySelector<HTMLElement>('[data-balance]')! })
